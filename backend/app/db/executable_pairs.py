...
def _snapshot(pair: ExecutablePair) -> dict[str, object]:
    return {
        ...
        "kalshi_market_url": pair.kalshi_market_url,
        ...
        "polymarket_market_url": pair.polymarket_market_url,
        "polymarket_resolution_source": pair.polymarket_resolution_source,
...
def _record(snapshot: dict[str, object]) -> ExecutablePair:
    ...
    return ExecutablePair(
        ...
        kalshi_market_url=str(snapshot.get("kalshi_market_url") or ""),
        ...
        polymarket_market_url=str(snapshot.get("polymarket_market_url") or ""),
        polymarket_resolution_source=str(snapshot.get("polymarket_resolution_source") or ""),
